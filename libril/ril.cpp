...
RIL_register (const RIL_RadioFunctions *callbacks) {
    ...
    if (inst != NULL) {
        g_strlcat(rildebug, inst, MAX_DEBUG_SOCKET_NAME_LENGTH);
    }
...
*/
    switch(request) {
        ...
        case RIL_REQUEST_QUERY_EMERGENCY_CALLBACK_MODE: return "RIL_REQUEST_QUERY_EMERGENCY_CALLBACK_MODE";
        ...
        case RIL_REQUEST_GET_HIGH_CAPABILITY : return "RIL_REQUEST_GET_HIGH_CAPABILITY";
        ...
        case RIL_REQUEST_SET_EMERGENCY_MODE_AND_ANT_SWITCH : return "RIL_REQUEST_SET_EMERGENCY_MODE_AND_ANT_SWITCH";
#endif /* RIL_FOR_MDM_LE */
