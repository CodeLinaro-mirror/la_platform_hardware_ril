...
typedef enum {
    ...
    RIL_PERSOSUBSTATE_SIM_SPN                   = 100,
    RIL_PERSOSUBSTATE_SIM_SPN_PUK               = 101,
    RIL_PERSOSUBSTATE_SIM_SP_EHPLMN             = 102,
    RIL_PERSOSUBSTATE_SIM_SP_EHPLMN_PUK         = 103,
    RIL_PERSOSUBSTATE_SIM_ICCID                 = 104,
    RIL_PERSOSUBSTATE_SIM_ICCID_PUK             = 105,
    RIL_PERSOSUBSTATE_SIM_IMPI                  = 106,
    RIL_PERSOSUBSTATE_SIM_IMPI_PUK              = 107,
    RIL_PERSOSUBSTATE_SIM_NS_SP                 = 108,
    RIL_PERSOSUBSTATE_SIM_NS_SP_PUK             = 109,
    RIL_PERSOSUBSTATE_SIM_RSU_NO_CK             = 200
