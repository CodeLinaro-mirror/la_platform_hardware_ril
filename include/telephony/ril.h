...
typedef enum {
    ...
    CALL_FAIL_CAUSE_HO_NOT_FEASIBLE = 382,
    CALL_FAIL_CAUSE_LOW_BATTERY = 503,
    ...
    CALL_FAIL_CAUSE_ANSWERED_ELSEWHERE = 1014,
    CALL_FAIL_CAUSE_SRV_NOT_REGISTERED = 3010,
    CALL_FAIL_CAUSE_CALL_TYPE_NOT_ALLOWED = 3011,
    CALL_FAIL_CAUSE_EMRG_CALL_ONGOING = 3012,
    CALL_FAIL_CAUSE_CALL_SETUP_ONGOING = 3013,
    CALL_FAIL_CAUSE_MAX_CALL_LIMIT_REACHED = 3014,
    CALL_FAIL_CAUSE_UNSUPPORTED_SIP_HDRS = 3015,
    CALL_FAIL_CAUSE_CALL_TRANSFER_ONGOING = 3016,
    CALL_FAIL_CAUSE_PRACK_TIMEOUT = 3017,
    CALL_FAIL_CAUSE_QOS_FAILURE = 3018,
    CALL_FAIL_CAUSE_ONGOING_HANDOVER = 3019,
    CALL_FAIL_CAUSE_VT_WITH_TTY_NOT_ALLOWED = 3020,
    CALL_FAIL_CAUSE_CALL_UPGRADE_ONGOING = 3021,
    CALL_FAIL_CAUSE_CONFERENCE_WITH_TTY_NOT_ALLOWED = 3022,
    CALL_FAIL_CAUSE_CALL_CONFERENCE_ONGOING = 3023,
    CALL_FAIL_CAUSE_VT_WITH_AVPF_NOT_ALLOWED = 3024,
    CALL_FAIL_CAUSE_ENCRYPTION_CALL_ONGOING = 3025,
    CALL_FAIL_CAUSE_CS_CALL_ONGOING = 3030,
    CALL_FAIL_CAUSE_REJECTED_ELSEWHERE = 3031,
    CALL_FAIL_CAUSE_RETRY_ON_IMS_WITHOUT_RTT = 3049,
    CALL_FAIL_THERMAL_EMERGENCY = 3100,  /* Thermal emergency. */
    CALL_FAIL_CLIENT_END = 6000, /* Extended for modem mapping. */
    CALL_FAIL_INCOM_REJ = 6001,
    CALL_FAIL_NO_GW_SRV = 6002,
    CALL_FAIL_NO_FULL_SRV = 6003,
    CALL_FAIL_CDMA_MAX_ACCESS_PROBE = 6004,
    CALL_FAIL_CDMA_PSIST_N = 6005,
    CALL_FAIL_USSD = 6006,
    CALL_FAIL_REJECTED_BY_USER = 6007,
    CALL_FAIL_NORMAL_CALL_CLEARING = 6008,
    CALL_FAIL_NORMAL_CALL_RINGBACK_TIMEOUT = 6009,
    CALL_FAIL_UIM_NOT_PRESENT = 6010,
    CALL_FAIL_INCOMPATIBLE = 6011,
    CALL_FAIL_ALREADY_IN_TC = 6012,
    CALL_FAIL_USER_CALL_ORIG_DURING_GPS = 6013,
    CALL_FAIL_USER_CALL_ORIG_DURING_SMS = 6014,
    CALL_FAIL_USER_CALL_ORIG_DURING_DATA = 6015,
    CALL_FAIL_TRM_REQ_FAIL = 6016,
    CALL_FAIL_CALL_CANNOT_BE_IDENTIFIED = 6017,
    CALL_FAIL_INCORRECT_SEMANTICS_IN_MESSAGE = 6018,
    CALL_FAIL_MANDATORY_INFORMATION_INVALID = 6019,
    CALL_FAIL_WRONG_STATE = 6020,
    CALL_FAIL_INVALID_USER_DATA = 6021,
    CALL_FAIL_CNM_MM_REL_PENDING = 6022,
    CALL_FAIL_ACCESS_STRATUM_REJ_LOW_LEVEL_FAIL = 6023,
    CALL_FAIL_ACCESS_STRATUM_REJ_LOW_LEVEL_FAIL_REDIAL_NOT_ALLOWED = 6024,
    CALL_FAIL_ACCESS_STRATUM_REJ_LOW_LEVEL_IMMED_RETRY = 6025,
    CALL_FAIL_ACCESS_STRATUM_REJ_ABORT_RADIO_UNAVAILABLE = 6026,
    CALL_FAIL_CCS_NOT_SUPPORTED_BY_BS = 6027,
    CALL_FAIL_REJECTED_BY_BS = 6028,
    CALL_FAIL_ACC_FAIL_REJ_ORD = 6029,
    CALL_FAIL_ACC_FAIL_RETRY_ORD = 6030,
    CALL_FAIL_UNKNOWN_SUBSCRIBER = 6031,
    CALL_FAIL_ILLEGAL_SUBSCRIBER = 6032,
    CALL_FAIL_BEARER_SERVICE_NOT_PROVISIONED = 6033,
    CALL_FAIL_TELE_SERVICE_NOT_PROVISIONED = 6034,
    CALL_FAIL_ILLEGAL_EQUIPMENT = 6035,
    CALL_FAIL_ILLEGAL_SS_OPERATION = 6036,
    CALL_FAIL_SS_ERROR_STATUS = 6037,
    CALL_FAIL_SS_NOT_AVAILABLE = 6038,
    CALL_FAIL_SS_SUBSCRIPTION_VIOLATION = 6039,
    CALL_FAIL_SS_INCOMPATIBILITY = 6040,
    CALL_FAIL_FACILITY_NOT_SUPPORTED = 6041,
    CALL_FAIL_ABSENT_SUBSCRIBER = 6042,
    CALL_FAIL_SHORT_TERM_DENIAL = 6043,
    CALL_FAIL_LONG_TERM_DENIAL = 6044,
    CALL_FAIL_SYSTEM_FAILURE = 6045,
    CALL_FAIL_IMSI_UNKNOWN_IN_HLR = 6046,
    CALL_FAIL_ILLEGAL_MS = 6047,
    CALL_FAIL_ILLEGAL_ME = 6048,
    CALL_FAIL_PLMN_NOT_ALLOWED = 6049,
    CALL_FAIL_LOCATION_AREA_NOT_ALLOWED = 6050,
    CALL_FAIL_ROAMING_NOT_ALLOWED_IN_THIS_LOCATION_AREA = 6051,
    CALL_FAIL_NO_SUITABLE_CELLS_IN_LOCATION_AREA = 6052,
    CALL_FAIL_NETWORK_FAILURE = 6053,
    CALL_FAIL_MAC_FAILURE = 6054,
    CALL_FAIL_SYNCH_FAILURE = 6055,
    CALL_FAIL_GSM_AUTHENTICATION_UNACCEPTABLE = 6056,
    CALL_FAIL_SERVICE_NOT_SUBSCRIBED = 6057,
    CALL_FAIL_ABORT_MSG_RECEIVED = 6058,
    CALL_FAIL_SERVICE_OPTION_NOT_SUPPORTED = 6059,
    CALL_FAIL_AS_REJ_LRRC_CONN_EST_FAILURE_CONN_REJECT = 6060,
    CALL_FAIL_EMM_REJ_SERVICE_REQ_FAILURE_LTE_NW_REJECT = 6061,
    CALL_FAIL_EMM_REJ_SERVICE_REQ_FAILURE_CS_DOMAIN_NOT_AVAILABLE = 6062,
    CALL_FAIL_EMM_REJ = 6063,
    CALL_FAIL_NETWORK_RESP_TIMEOUT_FROM_BS = 6064,
    CALL_FAIL_NETWORK_RESP_TIMEOUT_T42 = 6065,
    CALL_FAIL_NETWORK_RESP_TIMEOUT_T40 = 6066,
    CALL_FAIL_NETWORK_RESP_TIMEOUT_T50 = 6067,
    CALL_FAIL_NETWORK_RESP_TIMEOUT_T51 = 6068,
    CALL_FAIL_NETWORK_RESP_TIMEOUT_BAD_FL = 6069,
    CALL_FAIL_NETWORK_RESP_TIMEOUT_T41 = 6070,
    CALL_FAIL_NETWORK_RESP_TIMEOUT_T3230 = 6071,
    CALL_FAIL_NETWORK_RESP_TIMEOUT_T303 = 6072,
    CALL_FAIL_NETWORK_RESP_TIMEOUT_MT_CSFB = 6073,
    CALL_FAIL_NETWORK_RESP_TIMEOUT_T3417_EXT = 6074,
    CALL_FAIL_NETWORK_RESP_TIMEOUT_T3417 = 6075,
    CALL_FAIL_RADIO_ACCESS_FAILURE_REJ_RR_RANDOM = 6076,
    CALL_FAIL_RADIO_ACCESS_ESR_FAILURE = 6077,
    CALL_FAIL_RADIO_ACCESS_CS_ACQ_FAILURE = 6078,
    CALL_FAIL_ACCESS_BARRED = 6079,
    CALL_FAIL_SSAC_REJECT = 6080,
    CALL_FAIL_RADIO_RELEASE_NORMAL_REJ_RR_REL = 6081,
    CALL_FAIL_RADIO_RELEASE_NORMAL_REJ_RRC_REL = 6082,
    CALL_FAIL_RADIO_RELEASE_NORMAL_OOS_DURING_CRE = 6083,
    CALL_FAIL_RADIO_RELEASE_ABNORMAL_CLOSE_SESSION_IND = 6084,
    CALL_FAIL_RADIO_RELEASE_ABNORMAL_OPEN_SESSION_FAILURE = 6085,
    CALL_FAIL_RADIO_RELEASE_ABNORMAL_CRE_FAILURE = 6086,
    CALL_FAIL_RADIO_RELEASE_ABNORMAL_SIB_READ_ERROR = 6087,
    CALL_FAIL_RADIO_RELEASE_ABNORMAL_ABORTED_IRAT_SUCCESS = 6088,
    CALL_FAIL_RADIO_UPLINK_FAILURE_TXN = 6089,
    CALL_FAIL_RADIO_UPLINK_FAILURE_HO = 6090,
    CALL_FAIL_RADIO_UPLINK_FAILURE_CTRL_NOT_CONN = 6091,
    CALL_FAIL_RADIO_LINK_FAILURE_UL_DATA_CNF = 6092,
    CALL_FAIL_RADIO_LINK_FAILURE_EST_FAILURE = 6093,
    CALL_FAIL_RADIO_LINK_FAILURE_CONN_REL_RLF = 6094,
    CALL_FAIL_RADIO_LINK_FAILURE_REJ = 6095,
    CALL_FAIL_RADIO_LINK_FAILURE_DURING_CC_DISCONNECT = 6096,
    CALL_FAIL_RADIO_SETUP_FAILURE_REJ = 6097,
    CALL_FAIL_RADIO_SETUP_FAILURE_ABORTED = 6098,
    CALL_FAIL_RADIO_SETUP_FAILURE_CELL_RESEL = 6099,
    CALL_FAIL_RADIO_SETUP_FAILURE_CONFIG_FAILURE = 6100,
    CALL_FAIL_RADIO_SETUP_FAILURE_TIMER_EXPIRED = 6101,
    CALL_FAIL_RADIO_SETUP_FAILURE_SI_FAILURE = 6102,
    CALL_FAIL_NETWORK_DETACH_WITH_OUT_REATTACH = 6103,
    CALL_FAIL_PDN_DISCONNECTED = 6104,
    CALL_FAIL_1XCSFB_FAILURE_FAILURE_CALL_REL_NW_REL_ODR = 6105,
    CALL_FAIL_1XCSFB_FAILURE_FAILURE_CALL_REL_REG_REJ = 6106,
    CALL_FAIL_1XCSFB_FAILURE_FAILURE_RETRY_EXHAUST = 6107,
    CALL_FAIL_1XCSFB_FAILURE_FAILURE_USER_CALL_END = 6108,
    CALL_FAIL_1XCSFB_FAILURE_SRCH_TT_FAIL = 6109,
    CALL_FAIL_1XCSFB_FAILURE_TCH_INIT_FAIL = 6110,
    CALL_FAIL_1XCSFB_FAIL_ACQ_FAIL = 6111,
    CALL_FAIL_1XCSFB_FAIL_CALL_REL_INTERCEPT_ORDER = 6112,
    CALL_FAIL_1XCSFB_FAIL_CALL_REL_NORMAL = 6113,
    CALL_FAIL_1XCSFB_FAIL_CALL_REL_OTASP_SPC_ERR = 6114,
    CALL_FAIL_1XCSFB_FAIL_CALL_REL_REL_ORDER = 6115,
    CALL_FAIL_1XCSFB_FAIL_CALL_REL_REORDER = 6116,
    CALL_FAIL_1XCSFB_FAIL_CALL_REL_SO_REJ = 6117,
    CALL_FAIL_1XCSFB_HARD_FAILURE = 6118,
    CALL_FAIL_1XCSFB_HO_FAILURE = 6119,
    CALL_FAIL_1XCSFB_MSG_IGNORE = 6120,
    CALL_FAIL_1XCSFB_MSG_INVAILD = 6121,
    CALL_FAIL_1XCSFB_SOFT_FAILURE = 6122,
    CALL_FAIL_ACCESS_BLOCK = 6123,
    CALL_FAIL_ACC_IN_PROG = 6124,
    CALL_FAIL_ACTIVATION = 6125,
    CALL_FAIL_ADDRESS_INCOMPLETE = 6126,
    CALL_FAIL_ALERT_STOP = 6127,
    CALL_FAIL_ALTERNATE_EMERGENCY_CALL = 6128,
    CALL_FAIL_ALTERNATE_SERVICE = 6129,
    CALL_FAIL_AMBIGUOUS = 6130,
    CALL_FAIL_AS_REJ_LRRC_CONN_EST_FAILURE_NOT_CAMPED = 6131,
    CALL_FAIL_AS_REJ_LRRC_CONN_EST_SUCCESS = 6132,
    CALL_FAIL_BAD_EXTENSION = 6133,
    CALL_FAIL_BAD_GATEWAY = 6134,
    CALL_FAIL_BAD_REQ_WAIT_INVITE = 6135,
    CALL_FAIL_BAD_REQ_WAIT_REINVITE = 6136,
    CALL_FAIL_BUSY_EVERYWHERE = 6137,
    CALL_FAIL_CALL_COMPLETED_ELSEWHERE = 6138,
    CALL_FAIL_CALL_DEFLECTED = 6139,
    CALL_FAIL_CALL_OR_TRANS_DOES_NOT_EXIST = 6140,
    CALL_FAIL_CALL_PULLED = 6141,
    CALL_FAIL_CALL_PULL_OUT_OF_SYNC = 6142,
    CALL_FAIL_CCBS_NOT_POSSIBLE = 6143,
    CALL_FAIL_CCBS_POSSIBLE = 6144,
    CALL_FAIL_CLIR_NOT_SUBSCRIBED = 6145,
    CALL_FAIL_CODEC_ERROR = 6146,
    CALL_FAIL_CSFB_NOT_FEASIBLE_IN_ROAM_CS_NW = 6147,
    CALL_FAIL_CS_HARD_FAILURE = 6148,
    CALL_FAIL_CUG_CALL_FAILURE_UNSPECIFIED = 6149,
    CALL_FAIL_CUG_INDEX_INCOMPATIBLE = 6150,
    CALL_FAIL_DATA_CONNECTION_LOST = 6151,
    CALL_FAIL_DATA_MISSING = 6152,
    CALL_FAIL_DEAD_BATTERY = 6153,
    CALL_FAIL_DEFLECTION_TO_SERVED_SUBSCRIBER = 6154,
    CALL_FAIL_DOES_NOT_EXIST_ANYWHERE = 6155,
    CALL_FAIL_DRVCC_END_CALL = 6156,
    CALL_FAIL_DRVCC_IN_PROG = 6157,
    CALL_FAIL_EXTENSION_REQUIRED = 6158,
    CALL_FAIL_FALLBACK_TO_CS = 6159,
    CALL_FAIL_GONE = 6160,
    CALL_FAIL_INCOMING_REJ_CAUSE_1X_COLLISION = 6161,
    CALL_FAIL_INCOMING_REJ_CAUSE_CALL_ONGOING_CB_ENABLED = 6162,
    CALL_FAIL_INCOMING_REJ_CAUSE_CALL_ONGOING_CW_DISABLED = 6163,
    CALL_FAIL_INCOMING_REJ_CAUSE_CALL_ON_OTHER_SUB = 6164,
    CALL_FAIL_INCOM_REJ_CAUSE_UI_NOT_READY = 6165,
    CALL_FAIL_INTERVAL_TOO_BRIEF = 6166,
    CALL_FAIL_INVALID_DEFLECTED_TO_NUMBER = 6167,
    CALL_FAIL_INVALID_REMOTE_URI = 6168,
    CALL_FAIL_IS707B_MAX_ACC = 6169,
    CALL_FAIL_LOOP_DETECTED = 6170,
    CALL_FAIL_MC_ABORT = 6171,
    CALL_FAIL_MERGED_TO_CONFERENCE = 6172,
    CALL_FAIL_MESSAGE_TOO_LARGE = 6173,
    CALL_FAIL_METHOD_NOT_ALLOWED = 6174,
    CALL_FAIL_MOVED_PERMANENTLY = 6175,
    CALL_FAIL_MOVED_TEMPORARILY = 6176,
    CALL_FAIL_MPTY_PARTICIPANTS_EXCEEDED = 6177,
    CALL_FAIL_MULTIPLE_CHOICES = 6178,
    CALL_FAIL_NEGATIVE_PWD_CHECK = 6179,
    CALL_FAIL_NETWORK_NO_RESP_HOLD_FAIL = 6180,
    CALL_FAIL_NETWORK_NO_RESP_TIME_OUT = 6181,
    CALL_FAIL_NOT_ACCEPTABLE = 6182,
    CALL_FAIL_NOT_ACCEPTABLE_GLOBAL = 6183,
    CALL_FAIL_NOT_ACCEPTABLE_HERE = 6184,
    CALL_FAIL_NOT_IMPLEMENTED = 6185,
    CALL_FAIL_NO_CDMA_SRV = 6186,
    CALL_FAIL_NO_CELL_AVAILABLE = 6187,
    CALL_FAIL_NO_CUG_SELECTION = 6188,
    CALL_FAIL_NO_NETWORK_RESP = 6189,
    CALL_FAIL_NO_RESOURCES = 6190,
    CALL_FAIL_NUM_OF_PWD_ATTEMPTS_VIOLATION = 6191,
    CALL_FAIL_OTASP_SPC_ERR = 6192,
    CALL_FAIL_OUTGOING_CALLS_BARRED_WITHIN_CUG = 6193,
    CALL_FAIL_PAYMENT_REQUIRED = 6194,
    CALL_FAIL_POSITION_METHOD_FAILURE = 6195,
    CALL_FAIL_PRECONDITION_FAILURE = 6196,
    CALL_FAIL_PROXY_AUTHENTICATION_REQUIRED = 6197,
    CALL_FAIL_PWD_REGISTRATION_FAILURE = 6198,
    CALL_FAIL_REDIR_OR_HANDOFF = 6199,
    CALL_FAIL_REG_RESTORATION = 6200,
    CALL_FAIL_REMOTE_UNSUPP_MEDIA_TYPE = 6201,
    CALL_FAIL_REQUEST_ENTITY_TOO_LARGE = 6202,
    CALL_FAIL_REQUEST_PENDING = 6203,
    CALL_FAIL_REQUEST_TERMINATED = 6204,
    CALL_FAIL_REQUEST_URI_TOO_LARGE = 6205,
    CALL_FAIL_RESOURCES_NOT_AVAILABLE = 6206,
    CALL_FAIL_RRC_CONN_REL_NO_MT_SETUP = 6207,
    CALL_FAIL_RTP_FAILURE = 6208,
    CALL_FAIL_RTP_RTCP_TIMEOUT = 6209,
    CALL_FAIL_SERVER_INTERNAL_ERROR = 6210,
    CALL_FAIL_SERVER_TIME_OUT = 6211,
    CALL_FAIL_SERVER_UNAVAILABLE = 6212,
    CALL_FAIL_SESS_DESCR_NOT_ACCEPTABLE = 6213,
    CALL_FAIL_SIP_403_FORBIDDEN = 6214,
    CALL_FAIL_SIP_503_SERVER_UNAVAILABLE = 6215,
    CALL_FAIL_SPECIAL_SERVICE_CODE = 6216,
    CALL_FAIL_SRVCC_END_CALL = 6217,
    CALL_FAIL_SRV_INIT_FAIL = 6218,
    CALL_FAIL_TOO_MANY_HOPS = 6219,
    CALL_FAIL_UNAUTHORIZED = 6220,
    CALL_FAIL_UNDECIPHERABLE = 6221,
    CALL_FAIL_UNEXPECTED_DATA_VALUE = 6222,
    CALL_FAIL_UNKNOWN_ALPHABET = 6223,
    CALL_FAIL_UNKNOWN_CUG_INDEX = 6224,
    CALL_FAIL_UNSUPPORTED_SDP = 6225,
    CALL_FAIL_UNSUPPORTED_URI_SCHEME = 6226,
    CALL_FAIL_UNWANTED_CALL = 6227,
    CALL_FAIL_UPGRADE_DOWNGRADE_CANCELLED = 6228,
    CALL_FAIL_UPGRADE_DOWNGRADE_FAILED = 6229,
    CALL_FAIL_UPGRADE_DOWNGRADE_REJ = 6230,
    CALL_FAIL_USE_PROXY = 6231,
    CALL_FAIL_VERSION_NOT_SUPPORTED = 6232,
...
typedef struct {
   ...
   RIL_Reason_Type reason; /**< Indicates the reason for redial of eCall to be performed or not */
} RIL_ECall_Redial_Info;
 ...
 */
  ...
  *  GENERIC_FAILURE
  */
 #define RIL_REQUEST_SET_ANT_SWITCH 149
 ...
 *
 */
#define RIL_UNSOL_ECALL_HLAP_TIMER_EVENT 1052
 ...
 *
 */
#define RIL_UNSOL_ECALL_STATUS_EVENT 1053
 ...
 *
 */
#define RIL_UNSOL_UPDATE_CURRENT_CALLS_AND_FAILURE_CAUSE 1055
